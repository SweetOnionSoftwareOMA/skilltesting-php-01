...
<?php
						$attributes = array('method' => 'POST', 'id' => 'edit_role');
						$hidden = array('role_id' => $role->role_id);?>
...
<?php
															...
															$data = array('name' => $inputName,
																		  'id' => $inputName,
								        								  'value' => '1',
								        								  'checked' => to_boolean($role->super_admin),
...
<?php
															...
															$data = array('name' => $inputName,
																		  'id' => $inputName,
								        								  'value' => '1',
								        								  'checked' => to_boolean($role->office_manager_can_assign),
								        								  'class' => 'custom-control-input',
								        								  'tabindex' => '5');?>
															<div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
																<?php echo form_checkbox($data);?>
...
<?php
												...
												$permission_id = array();
												foreach ($permissions_roles as $row) :
												...
												foreach ($permissions as $row) :?>
													<div class="col-md-4">
														<div class="form-check">
															<input class="form-check-input" type="checkbox" value="<?php echo $row->permission_id;?>" id="cbPermissions<?php echo $row->permission_id;?>" name="cbPermissions[]"<?php echo $required;?><?php echo ((in_array($row->permission_id, $permission_id)) ? ' checked' : '' );?>>
								...
								<div class="col-lg-12 col-sm-12">
			            			...
			            			<div class="card card-secondary">
			              				<div class="card-body text-center">
											<input type="submit" class="btn btn-primary" value="Update Role" tabindex="8" />

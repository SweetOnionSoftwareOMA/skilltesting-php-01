...
<?php
			$attributes = array('method' => 'POST', 'id' => 'edit_office_user');
...
<?php
									...
									$office_id = array();
									foreach ($user_selected_offices as $row) :
									...
									foreach ($user_offices as $key => $value) :?>
										<div class="col-md-4">
											<div class="form-check">
												<input class="form-check-input" type="checkbox" value="<?php echo $key;?>" id="cbOffices<?php echo $key;?>" name="cbOffices[]"<?php echo $required;?><?php echo ((in_array($key, $office_id)) ? ' checked' : '' );?>>
...
<?php
									...
									$role_id = array();
									foreach ($user_assigned_roles as $row) :
										$role_id[] = $row['role_id'];
									endforeach;
					...
					<div class="col-lg-12 col-sm-12">
            			...
            			<div class="card card-secondary">
              				<div class="card-body text-center">
								<input type="submit" class="btn btn-primary" value="Update User" tabindex="9" />

...
<?php
	            				...
	            				<table align="center" border="1" cellpadding="5" cellspacing="0" style="width:100%;max-width:515px;min-width:300px;background-color:#fff;border-collapse:collapse;margin:0px 0px 0px;">
	            					...
	            					<tr>
	            						...
	            						<td width="25%" align="left"><?php echo $form_data[$i]['location_gross_sales'];?></td>
	            					</tr>
	            					<tr>
	            						...
	            						<td style="background-color:#ECECEC;" align="left"><?php echo $form_data[$i]['secondpair_eligible'];?></td>
	            					</tr>
	            					<tr>
	            						<td><h3 style="font-size:16px;font-weight:bold;margin:0;text-align:right;">Second Pairs Sold</h3></td>
	            						<td align="left"><?php echo $form_data[$i]['secondpair_accepted'];?></td>
	            					</tr>
	            					<tr>
	            						...
	            						<td style="background-color:#ECECEC;" align="right"><?php echo number_format($form_data[$i]['secondpair_conversion_rate'], 2);?>%</td>
	            					</tr>
	            				</table>

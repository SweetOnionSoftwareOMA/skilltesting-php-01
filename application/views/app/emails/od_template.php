...
<?php
	            				...
	            				<table align="center" border="1" cellpadding="5" cellspacing="0" style="width:100%;max-width:515px;min-width:300px;background-color:#fff;border-collapse:collapse;margin:0px 0px 20px;">
	            					...
	            					<tr>
	            						...
	            						<td width="25%" align="left"><?php echo $form_data['routine_encounters'];?></td>
	            					</tr>
	            					<tr>
	            						...
	            						<td style="background-color:#ECECEC;" align="left"><?php echo $form_data['followup_encounters'];?></td>
	            					</tr>
	            					<tr>
	            						<td><h3 style="font-size:16px;font-weight:bold;margin:0;text-align:right;">Conversion Rate</h3></td>
	            						<td align="right"><?php echo number_format($form_data['followup_routing_rate'], 2);?>%</td>
	            					</tr>
	            				</table>
	            				<table align="center" border="1" cellpadding="5" cellspacing="0" style="width:100%;max-width:515px;min-width:300px;background-color:#fff;border-collapse:collapse;margin:0px 0px 20px;">
	            					<tr>
	            					...
	            					<tr>
	            						...
	            						<td width="25%" align="left"><?php echo $form_data['neurolens_eligble_patients'];?></td>
	            					</tr>
	            					<tr>
	            						...
	            						<td style="background-color:#ECECEC;" align="left"><?php echo $form_data['neurolens_accepted'];?></td>
	            					</tr>
	            					<tr>
	            						<td><h3 style="font-size:16px;font-weight:bold;margin:0;text-align:right;">Neurolens Conversion Rate</h3></td>
	            						<td align="right"><?php echo number_format($form_data['neurolens_conversion_rate'], 2);?>%</td>
	            					</tr>
	            				</table>
<?php
								if (to_boolean($form_data['has_ose_data'])):?>
	            				<table align="center" border="1" cellpadding="5" cellspacing="0" style="width:100%;max-width:515px;min-width:300px;background-color:#fff;border-collapse:collapse;margin:0px 0px 20px;">
	            					<tr>
	            					...
	            					<tr>
	            						...
	            						<td width="25%" align="left"><?php echo $form_data['occular_surface_scheduled'];?></td>
	            					</tr>
	            					<tr>
	            						<td style="background-color:#ECECEC;"><h3 style="font-size:16px;font-weight:bold;margin:0;text-align:right;">OSEs Performed</h3></td>
	            						<td style="background-color:#ECECEC;" align="left"><?php echo $form_data['occular_surface_performed'];?></td>
	            					</tr>
	            					<tr>
	            						<td><h3 style="font-size:16px;font-weight:bold;margin:0;text-align:right;">No Show Rate</h3></td>
	            						<td align="right"><?php echo number_format($form_data['occular_surface_exam_rate'], 2);?>%</td>
	            					</tr>
	            					<tr>
	            						...
	            						<td style="background-color:#ECECEC;" align="left"><?php echo $form_data['lipiflow_treatments_performed'];?></td>
	            					</tr>
	            					<tr>
	            						<td><h3 style="font-size:16px;font-weight:bold;margin:0;text-align:right;">Lipiflow Conversion Rate</h3></td>
	            						<td align="right"><?php echo number_format($form_data['lipiflow_conversion_rate'], 2);?>%</td>
	            					</tr>
	            				</table>
<?php
								endif;?>
	            				<table align="center" border="1" cellpadding="5" cellspacing="0" style="width:100%;max-width:515px;min-width:300px;background-color:#fff;border-collapse:collapse;margin:0px 0px 20px;">
	            					...
	            					<tr>
	            						...
	            						<td width="25%" align="left"><?php echo $form_data['myopia_eligble_patients'];?></td>
	            					</tr>
	            					<tr>
	            						...
	            						<td style="background-color:#ECECEC;" align="left"><?php echo $form_data['myopia_accepted'];?></td>
	            					</tr>
	            					<tr>
	            						<td><h3 style="font-size:16px;font-weight:bold;margin:0;text-align:right;">Myopia Conversion Rate</h3></td>
	            						<td align="right"><?php echo number_format($form_data['myopia_conversion_rate'], 2);?>%</td>
	            					</tr>
	            				</table>
